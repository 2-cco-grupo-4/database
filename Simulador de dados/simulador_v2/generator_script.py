    ...
    with SessionLocal() as db:
        ...
        try:
            ...
            for x in listTags:
                ...
                insert = f"INSERT INTO tb_tag (nome) VALUES ('{tag.nome}');"
        ...
        try:
            ...
            for x in listTemas:
                ...
                insert = f"INSERT INTO tb_tema (nome) VALUES ('{tema.nome}');"
                inserts.append(insert)
        ...
        try:
            ...
            for _ in range(50000):  # Altere conforme necessário - Para cada 10 usuários, gerar 1 fotógrafo
                ...
                insert = f"INSERT INTO tb_usuario (nome, cpf, email, senha, data_nascimento, celular, tipo_usuario, cidade_preferencia, estado_preferencia, autenticado, token_solicitacao, data_cadastro)" \
                         f"VALUES ('{usuario.nome}', '{usuario.cpf}', '{usuario.email}', '{usuario.senha}', '{usuario.data_nascimento}', '{usuario.celular}', {usuario.tipo_usuario}, '${usuario.cidade_preferencia}', '{usuario.estado_preferencia}', {usuario.autenticado}, '{usuario.token_solicitacao}', '{usuario.data_cadastro}')"
                ...
                if usuario.tipo_usuario == 2:
                    ...
                    for _ in range(3):  # Gerar 3 álbuns para cada fotógrafo
                        ...
                        insert = f"INSERT INTO tb_album (titulo, descricao, fk_fotografo, fk_tema)" \
                                 f"VALUES ('{album.titulo}', '{album.descricao}', {album.fk_fotografo}, {album.fk_tema})"
                        ...
                        for x in urls:
                            ...
                            insert = f"INSERT INTO tb_imagem (media_url, permalink, caption, media_type, origem_imagem, updated_at, fk_album)" \
                                     f"VALUES ('{imagem.media_url}', '{imagem.permalink}', '{imagem.caption}', '{imagem.media_type}', '{imagem.origem_imagem}', '{imagem.updated_at}', {imagem.fk_album})"
                            inserts.insert(insert)
                    ...
                    if fake.random_int(min=0, max=1) == 1:
                        for _ in range(fake.random_int(min=1, max=8)):  # Entre 1 e 8 sessões
                            ...
                            insert = f"INSERT INTO tb_sessao (data_realizacao, status_sessao, created_at, fk_fotografo, fk_cliente, fk_tema)" \
                                     f"VALUES ('{sessao.data_realizacao}', '{sessao.status_sessao}', '{sessao.created_at}', {sessao.fk_fotografo}, {sessao.fk_cliente}, {sessao.fk_tema})"
                            ...
                            insert = f"INSERT INTO tb_sessao (cep, logradouro, numero, complemento, bairro, cidade, estado, fk_sessao)" \
                                     f"VALUES ('{endereco.cep}', '{endereco.logradouro}', '{endereco.numero}', '{endereco.complemento}', '{endereco.bairro}', '{endereco.cidade}', '{endereco.estado}', {endereco.fk_sessao})"
                            ...
                            insert = f"INSERT INTO tb_pagamento (forma, valor, parcelas, fk_sessao)" \
                                     f"VALUES ('{pagamento.forma}', {pagamento.valor}, {pagamento.parcelas}, {pagamento.fk_sessao})"
        ...
        try:
            for _ in range(75000):
                ...
                insert = f"INSERT INTO tb_usuario_tag (id_tag, id_usuario)" \
                         f"VALUES ({usuario_tag.id_tag}, {usuario_tag.id_usuario})"
        ...
        try:
            for _ in range(26000):  # Altere conforme necessário - distribuir bastante a data login
                ...
                insert = f"INSERT INTO tb_log_acessos (fk_usuario, data_login)" \
